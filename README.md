...
🚩We warmly invite you to read our survey on MetaBBO, "[Toward Autonomous Algorithm Design: A Survey and Practical Guide to Meta-Black-Box-Optimization]()," for more detailed insights into MetaBBO!
...
|RGD|Beckham, Christopher, et al. "[**Robust Guided Diffusion for Offline Black-Box Optimization**](https://arxiv.org/abs/2410.00983)" arXiv preprint arXiv:2410.00983 (2024).|COP|-|[RGD](https://anonymous.4open.science/r/RGD-27A5/README.md)|
...
|DDOM|Krishnamoorthy, Siddarth, Satvik Mehul Mashkaria, and Aditya Grover. "[**Diffusion models for black-box optimization**](https://proceedings.mlr.press/v202/krishnamoorthy23a.html)" International Conference on Machine Learning. PMLR, (2023).|COP|-|[DDOM](https://github.com/siddarthk97/ddom)|
